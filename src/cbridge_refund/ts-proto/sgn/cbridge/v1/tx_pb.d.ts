...
export class MsgSendMySigResp extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: MsgSendMySigResp
  ): MsgSendMySigResp.AsObject;
  static serializeBinaryToWriter(
...
export class MsgInitWithdrawResp extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: MsgInitWithdrawResp
  ): MsgInitWithdrawResp.AsObject;
  static serializeBinaryToWriter(
...
export class MsgSignAgainResp extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: MsgSignAgainResp
  ): MsgSignAgainResp.AsObject;
  static serializeBinaryToWriter(
...
export class MsgUpdateLatestSigners extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: MsgUpdateLatestSigners
  ): MsgUpdateLatestSigners.AsObject;
  static serializeBinaryToWriter(
...
export class MsgUpdateLatestSignersResp extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: MsgUpdateLatestSignersResp
  ): MsgUpdateLatestSignersResp.AsObject;
  static serializeBinaryToWriter(
...
export class MsgSyncFarming extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: MsgSyncFarming
  ): MsgSyncFarming.AsObject;
  static serializeBinaryToWriter(
    message: MsgSyncFarming,
    writer: jspb.BinaryWriter
  ): void;
...
export class MsgSyncFarmingResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: MsgSyncFarmingResponse
  ): MsgSyncFarmingResponse.AsObject;
  static serializeBinaryToWriter(
