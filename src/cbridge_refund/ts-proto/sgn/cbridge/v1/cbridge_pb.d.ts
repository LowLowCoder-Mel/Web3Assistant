...
export class Params extends jspb.Message {
  ...
  getSignAgainCoolDownDuration():
    | google_protobuf_duration_pb.Duration
    | undefined;
  setSignAgainCoolDownDuration(
...
export class CbrConfig extends jspb.Message {
  ...
  setCbrContractsList(
    value: Array<sgn_common_v1_common_pb.ContractInfo>
  ): CbrConfig;
  ...
  addOverride(
    value?: PerChainPairAssetOverride,
    index?: number
...
export class RelayGasCostParam extends jspb.Message {
  ...
  static toObject(
    ...
    msg: RelayGasCostParam
  ): RelayGasCostParam.AsObject;
  static serializeBinaryToWriter(
...
export class PerChainPairAssetOverride extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: PerChainPairAssetOverride
  ): PerChainPairAssetOverride.AsObject;
  static serializeBinaryToWriter(
